...
## Homework for Week 2 - Responsiveness Assignment (2 of 2)

### Overview

In this assignment, we were asked to create two different portfolios. This repo consists of enhancing
the portfolio I made with a mobile-responsive layout.

### Assignment 2 of 2 Instructions - (No Bootstrap)
